...
export default function BookingForm() {
  ...
  const calculateTotal = () => {
    if (!crane || !formData.duration) return 0;
    let total = parseFloat(crane.price_per_hour) * parseInt(formData.duration);
  ...
  const handleSubmit = async () => {
    ...
    setSubmitting(true);
    try {
      const result = await createCraneBooking({
        crane_id: id,
        ...formData,
      });
        ...
        >
          ...
          <View style={{ flex: 1, marginLeft: 16 }}>
            ...
            <Text style={{ fontSize: 14, color: "#94a3b8" }}>
              {crane?.capacity} • ₹{crane?.price_per_hour}/hr
            </Text>
          </View>
        </View>
        ...
        >
          ...
          {formData.duration && (
            ...
            >
              ...
              >
                <Text style={{ fontSize: 14, color: "#94a3b8" }}>
                  {formData.duration} hours × ₹{crane?.price_per_hour}
                </Text>
                <Text style={{ fontSize: 14, color: "#94a3b8" }}>
                  ₹
                  {(
                    parseFloat(crane?.price_per_hour) *
